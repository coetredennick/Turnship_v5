...
const mockConnections = [
  ...
  },
  {
    ...
    last_contacted_at: new Date('2024-01-18T14:15:00Z'),
  ...
  },
  {
    ...
    grad_year: null,
    stage: 'Follow-up Due',
    last_contacted_at: new Date('2024-01-16T09:45:00Z'),
  ...
  },
  {
    ...
    grad_year: 2020,
    stage: 'Connected',
    last_contacted_at: new Date('2024-01-22T16:20:00Z'),
  ...
  },
  {
    ...
    grad_year: 2018,
    stage: 'Connected',
    last_contacted_at: new Date('2024-01-24T11:15:00Z'),
  ...
  },
  {
    ...
    grad_year: null,
    stage: 'First Outreach',
    last_contacted_at: new Date('2024-01-23T16:30:00Z'),
  ...
  },
  {
    ...
    grad_year: 2020,
    stage: 'Second Outreach',
    last_contacted_at: new Date('2024-01-21T14:45:00Z'),
  ...
  },
  {
    ...
    grad_year: null,
    stage: 'Follow-up Due',
    last_contacted_at: new Date('2024-01-19T10:20:00Z'),
  ...
  },
  {
    ...
    grad_year: 2017,
    stage: 'Connected',
    last_contacted_at: new Date('2024-01-26T09:30:00Z'),
...
const mockPrisma = {
  user: {
    ...
    create: (data) => {
      const user = { ...data.data, id: `user-${Date.now()}`, created_at: new Date() };
      mockUsers.push(user);
      return user;
    }
  },
  ...
  connection: {
    ...
    create: ({ data }) => {
      const connection = { 
        ...
        cycle: data.cycle || 1,
        nextAction: data.nextAction || 'PREPARE_FIRST',
        tags: data.tags || [],
